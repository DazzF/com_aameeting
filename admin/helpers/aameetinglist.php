...
/**
 * Aameetinglist component helper.
 */
abstract class AameetinglistHelper
{
	/**
	 * Composer Switch
	 * 
	...
	{
		$manifestUrl = JPATH_ADMINISTRATOR."/components/com_aameetinglist/aameetinglist.xml";
	...
	{
		// get params
		$params	= JComponentHelper::getParams('com_aameetinglist');
	...
	public static function addSubmenu($submenu)
	{
		...
		JHtmlSidebar::addEntry(JText::_('COM_AAMEETINGLIST_SUBMENU_DASHBOARD'), 'index.php?option=com_aameetinglist&view=aameetinglist', $submenu === 'aameetinglist');
		if ($user->authorise('aameeting.access', 'com_aameetinglist') && $user->authorise('aameeting.submenu', 'com_aameetinglist'))
		{
			JHtmlSidebar::addEntry(JText::_('COM_AAMEETINGLIST_SUBMENU_AAMEETINGS'), 'index.php?option=com_aameetinglist&view=aameetings', $submenu === 'aameetings');
		}
	}
	...
	*/
	 ...
	 *
	 */
	public static function getVar($table, $where = null, $whereString = 'user', $what = 'id', $operator = '=', $main = 'aameetinglist')
	{
		if(!$where)
		{
	 ...
	 *
	 */
	public static function getVars($table, $where = null, $whereString = 'user', $what = 'id', $operator = 'IN', $main = 'aameetinglist', $unique = true)
	{
		if(!$where)
		{
			$where = JFactory::getUser()->id;
	...
	public static function isPublished($id,$type)
	{
		...
		$query->from('#__aameetinglist_'.$type.' AS a');
	 ...
	 * 
	 */
	public static function getActions($view, &$record = null, $views = null, $target = null, $component = 'aameetinglist', $user = 'null')
	{
	 ...
	 */
	public static function getModel($name, $path = JPATH_COMPONENT_ADMINISTRATOR, $Component = 'Aameetinglist', $config = array())
	{
		// fix the name
	...
	public static function setAsset($id, $table, $inherit = true)
	{
		...
		$parent->loadByName('com_aameetinglist');
		
		$parentId = $parent->id;
		$name     = 'com_aameetinglist.'.$table.'.'.$id;
		$title    = '';
		...
		else
		{
			...
			$rules = self::getDefaultAssetRules('com_aameetinglist', $table, $inherit);
			...
			else
			{
				...
				return JFactory::getDbo()->updateObject('#__aameetinglist_'.$table, $object, 'id');
			}
		}
		return false;
	}
	...
	public static function transliterate($string)
	{
		...
		{
			// get global value
			self::$langTag = JComponentHelper::getParams('com_aameetinglist')->get('language', 'en-GB');
		}
