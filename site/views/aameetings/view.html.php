...
class AameetinglistViewAameetings extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$HeaderCheck = new aameetinglistHeaderCheck;
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_aameetinglist/assets/css/aameetings.css', (AameetinglistHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	public function escape($var, $sorten = false, $length = 40)
	{
		...
		return AameetinglistHelper::htmlEscape($var, $this->_charset, $sorten, $length);
	}
}
